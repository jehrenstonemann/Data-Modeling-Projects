...
> Compute a sequence of results of 2^n where n is a sequence of numbers from 0 to 5, inclusive and respectively.
...
> When there are even number of values in the list, median is the average between the value at index n/2 and the value at index 1+n/2 (1-based numbering; i.e. first element in the list starts at index 1)
